...
.SILENT all:
	...
	$(call perform_test,width,Width)
	$(call perform_test,extrawidth,"Extra width")
...
generate:
	...
	$(call generate_answers,width)
	$(call generate_answers,extrawidth)
...
merge:
	...
	$(call merge_test,width)
	$(call merge_test,extrawidth)
	$(call merge_test,bad)
