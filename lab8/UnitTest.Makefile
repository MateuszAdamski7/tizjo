...
.SILENT all:
	...
	$(call perform_test,length_specified,"Length specified")
	$(call perform_test,no_length_specified,"No length specified")
...
generate:
	...
	$(call generate_answers,length_specified)
	$(call generate_answers,no_length_specified)
...
merge:
	...
	$(call merge_test,length_specified)
	$(call merge_test,no_length_specified)
	$(call merge_test,bad)
